...
type FunctionDefinition struct {
	Definition *ResourceFunctionType
	Location   TypeLocation
	ApiVersion string
	mutex      sync.Mutex
}
...
func (o *TypeLocation) LoadResourceTypeDefinition() (*ResourceType, error) {
	if o == nil {
		return nil, nil
	}
	...
	var schema encodedSchema
	err = json.Unmarshal(data, &schema)
	if err != nil {
		return nil, err
	}
	if o.Index < len(schema.Types) && schema.Types[o.Index] != nil {
		if resourceType, ok := (*schema.Types[o.Index]).(*ResourceType); ok {
...
func (o *TypeLocation) LoadFunctionTypeDefinition() (*ResourceFunctionType, error) {
	if o == nil {
		return nil, nil
	}
	data, err := o.StaticFiles.ReadFile("bicep-types-az/generated/" + o.Location)
	...
	if o.Index < len(schema.Types) && schema.Types[o.Index] != nil {
		if resourceType, ok := (*schema.Types[o.Index]).(*ResourceFunctionType); ok {
			return resourceType, nil
		}
	}
	return nil, fmt.Errorf("index invalid or the type is not a resource type")
...
func (o *ResourceDefinition) GetDefinition() (*ResourceType, error) {
	if o == nil {
		return nil, nil
	}
	o.mutex.Lock()
...
func (o *FunctionDefinition) GetDefinition() (*ResourceFunctionType, error) {
	if o == nil {
		return nil, nil
	}
	o.mutex.Lock()
